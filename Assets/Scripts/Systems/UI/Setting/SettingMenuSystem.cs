...
namespace HalfDiggers.Runner
{
    public class SettingMenuSystem : IEcsInitSystem, IEcsRunSystem
    {
        ...
        private EcsFilter _filterMainPause;
        ...
        public void Init(IEcsSystems systems)
        {
          ...
          //  _filter = _world.Filter<BtnShowSettingMenu>().End();
            ...
            _filterMainPause = _world.Filter<IsMainMenu>().End();
        ...
        {
          //  foreach (var e in _filterMainPause)
          //  {
