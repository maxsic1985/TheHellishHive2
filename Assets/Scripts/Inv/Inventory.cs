...
public class Inventory : MonoBehaviour
{
        ...
        if (Input.GetMouseButtonUp(0))
        {
                    ...
                    .IsPointerOverGameObject(-1)) //клик за пределами инвентаря и объект выран
            {
                ...
                if (!GameObject.Find("DropItem(Clone)"))
                {
                    ...
                    tmpPanel.transform.SetParent(GameObject.Find("Canvas").GetComponent<RectTransform>().transform,
                        false);
                    Destroy(GameObject.Find("Hover"));
    ...
    private void MoveInventory()
    {
        ...
        RectTransformUtility.ScreenPointToLocalPointInRectangle(
            ...
            new Vector3(
                Input.mousePosition.x - (inventoryRect.sizeDelta.x / 2 * InventoryManager.Instance.canvas.scaleFactor),
    ...
    public void MoveItem(GameObject clicked)
    {
            ...
            //  if (cg != null && cg.alpha > 0 || clicked.transform.parent.parent.GetComponent<CanvasGroup>().alpha>0)
        {
                ...
                InventoryManager.Instance.From != null) //если быбраны слот from и слот to то можем двигать слоты
            {
                ...
                else if (!InventoryManager.Instance.To.isEmpty &&
    ...
    public void SplitStack()
    {
        ...
        {
            InventoryManager.Instance.MovingSlot.Items = InventoryManager.Instance.Clicked.GetComponent<Slot>()
                .RemoveItems(InventoryManager.Instance.SplitAmount);
    ...
    public void FustCloseInventory()
    {
